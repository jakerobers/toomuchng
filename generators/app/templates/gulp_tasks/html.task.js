		...
		html: {
			...
			web: {
				input: {
					templates: [
						...
						"assets/**/*.html",
						"!assets/**/*.mobile.html",
						"!assets/applications/mobile/*.html",
						"!assets/applications/web/*.html",
					],
					index: "assets/applications/web/index.web.html",
				},
				output: {
			...
			mobile: {
				input: {
					...
					index: "assets/applications/mobile/index.mobile.html",
				},
				output: {
